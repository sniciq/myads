Ext.onReady(function() {
							...
							new Ext.form.ComboBox({
								...
								listeners : {
									select : function(postemCombo, record, index) {
					                	...
					                	Ext.Ajax.request({
											method: 'post',
											url: '/myads/HTML/sysconfig/ProductLineAction_getProductLineById.action',
										   	success:function(resp){
										    	var obj=Ext.util.JSON.decode(resp.responseText);
									      		productLineCombStore.loadData(obj);
					...
					},
					{
						...
						items: [
							new Ext.form.ComboBox({
								...
								listeners : {
									select : function(postemCombo, record, index) {
										var id = record.data.dataType;
					                	Ext.Ajax.request({
											method: 'post',
											url: '/myads/HTML/sysconfig/ProductAction_getProductByLineId.action',
										   	success:function(resp){
										    	var obj=Ext.util.JSON.decode(resp.responseText);
									      		productCombStore.loadData(obj);
									      		
									      		var productLineName = record.data.dataValue;
					...
					},
					{
						...
						items: [
							new Ext.form.ComboBox({
								...
								listeners : {
								select : function(postemCombo, record, index) {
									var productName = record.data.dataValue;
	...
	var cm = new Ext.grid.ColumnModel([
	    ...
	    {header:'操作', dataIndex:'op', renderer: renderOp,width:120, align:'left'}
	]);
...
//		var advflight = '<a href="/myads/HTML/advflight/advflight.html">排期</a>';
	...
	var ds = new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({url: '/myads/HTML/advflight/ProjectAction_showAll.action?p=5'}),
		remoteSort: false,
