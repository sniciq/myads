Ext.onReady(function() {	
							...
							items: [
								new Ext.form.ComboBox({
									...
									store: new Ext.data.SimpleStore({
										...
										['4','退回项目单'],['5','未通过项目单'],['7','执行中项目单'],['71','执行中修改项目单'],['8','执行完成项目单']]
									})
			        	       })
							]
					},
	...
	function renderOp(value, cellmeta, record, rowIndex, columnIndex, stor) {
		...
		var advflight = '<a href="/myads/HTML/book/book.jsp?canUpdatePriority=true&projectId='+id+'">排期</a>';
	...
	var ds = new Ext.data.Store({
		proxy: new Ext.data.HttpProxy({url: '/myads/HTML/advflight/ProjectAction_showAll.action'}),
		remoteSort: false,
		reader: new Ext.data.JsonReader(
			{
				totalProperty: 'total',
